...
const App: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-black text-gray-200 flex flex-col font-sans overflow-hidden">
      ...
      <header className="py-6 flex items-center justify-center px-8 relative z-10 shrink-0">
      ...
      <main className="w-full max-w-4xl mx-auto flex-grow flex flex-col p-4 overflow-y-auto">
        {appState === AppState.IDLE ? (
          <>
            <div className="flex-grow flex items-center justify-center shrink-0 min-h-[100px]">
